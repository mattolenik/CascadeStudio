...
// import { STLExporter, OBJExporter, DragControls, OrbitControls, TransformControls } from 'three/examples/jsm/controls'
...
class CascadeStudio {
    constructor(projectContent = null) {
        ...
        myLayout.registerComponent('cascadeView', function (container, state) {
            ...
            myLayout.on("initialised", () => {
                ...
                threejsViewport = new CascadeEnvironment(container, messageHandlers);
            });
        });
...
const loadProject = async () => {
    ...
    window.history.replaceState({}, 'Cascade Studio','?');
    CascadeStudio(projectContent=jsonContent);
    codeContainer.setTitle(file.handle.name);
